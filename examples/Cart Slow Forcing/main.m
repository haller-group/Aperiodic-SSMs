...
h101 = (-6.*(gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(3, 4) + gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(3, 4) - gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(3, 5)))./((l1 - l2).*m1.*Mf);
hc101 = conj(h101);

h200 = (-3.*(gamma.*m1.*xi0.*P(1, 1).^2.*PI(3, 4) + gamma.*Mf.*xi0.*P(1, 1).^2.*PI(3, 4) - gamma.*Mf.*xi0.*P(1, 1).^2.*PI(3, 5)))./((2.*l1 - l2).*m1.*Mf);
hc200 = conj(h200);

h011 = (-6.*(gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(3, 4) + gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(3, 4) - gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(3, 5)))./((l1 - l2).*m1.*Mf);
hc011 = conj(h011);

h110 = (-6.*(gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(3, 4) + gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(3, 4) - gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(3, 5)))./((2.*l1 - l2).*m1.*Mf);
hc110 = conj(h110);

h020 = (-3.*(gamma.*m1.*xi0.*P(1, 2).^2.*PI(3, 4) + gamma.*Mf.*xi0.*P(1, 2).^2.*PI(3, 4) - gamma.*Mf.*xi0.*P(1, 2).^2.*PI(3, 5)))./((2.*l1 - l2).*m1.*Mf);
hc020 = conj(h020);

f101 = (-6.*(gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(5, 4) + gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(5, 4) - gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(5, 5)))./((l1 - l3).*m1.*Mf);
fc101 = conj(f101);

f200 = (-3.*(gamma.*m1.*xi0.*P(1, 1).^2.*PI(5, 4) + gamma.*Mf.*xi0.*P(1, 1).^2.*PI(5, 4) - gamma.*Mf.*xi0.*P(1, 1).^2.*PI(5, 5)))./((2.*l1 - l3).*m1.*Mf);
fc200 = conj(f200);

f011 = (-6.*(gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(5, 4) + gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(5, 4) - gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(5, 5)))./((l1 - l3).*m1.*Mf);
fc011 = conj(f011);

f110 = (-6.*(gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(5, 4) + gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(5, 4) - gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(5, 5)))./((2.*l1 - l3).*m1.*Mf);
fc110 = conj(f110);

f020 = (-3.*(gamma.*m1.*xi0.*P(1, 2).^2.*PI(5, 4) + gamma.*Mf.*xi0.*P(1, 2).^2.*PI(5, 4) - gamma.*Mf.*xi0.*P(1, 2).^2.*PI(5, 5)))./((2.*l1 - l3).*m1.*Mf);
fc020 = conj(f020);
...
h030 = (3.*gamma.*h110.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + 3.*gamma.*h110.*Mf.*xi0.*P(1, 2).^2.*PI(1, 4) - 3.*gamma.*h110.*Mf.*xi0.*P(1, 2).^2.*PI(1, 5) + 6.*gamma.*h020.*m1.*xi0.*P(1, 2).^2.*PI(2, 4) + ...
     ...
     6.*gamma.*hc020.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(3, 5) + 6.*f020.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(3, 5) + 6.*fc020.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 5))./((3.*l1 - l2).*m1.*Mf);
...
h120 = (3.*(2.*gamma.*h110.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 2.*gamma.*h110.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 2.*gamma.*h200.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + ...
      ...
      2.*fc110.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 5)))./((3.*l1 - l2).*m1.*Mf);
...
h210 = (3.*(gamma.*h110.*m1.*xi0.*P(1, 1).^2.*PI(1, 4) + gamma.*h110.*Mf.*xi0.*P(1, 1).^2.*PI(1, 4) + 4.*gamma.*h200.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + ...
      ...
      2.*fc110.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(3, 5) + 2.*fc200.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 5)))./((3.*l1 - l2).*m1.*Mf);
...
f030 = (3.*f110.*gamma.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + 3.*f110.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(1, 4) - 3.*f110.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(1, 5) + 6.*f020.*gamma.*m1.*xi0.*P(1, 2).^2.*PI(2, 4) + ...
     ...
     6.*gamma.*hc020.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(5, 5) + 6.*f020.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(5, 5) + 6.*fc020.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 5))./((3.*l1 - l3).*m1.*Mf);
...
f120 = (3.*(2.*f110.*gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 2.*f110.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 2.*f200.*gamma.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + ...
      ...
      2.*fc110.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 5)))./((3.*l1 - l3).*m1.*Mf);
...
f210 = (3.*(f110.*gamma.*m1.*xi0.*P(1, 1).^2.*PI(1, 4) + f110.*gamma.*Mf.*xi0.*P(1, 1).^2.*PI(1, 4) + 4.*f200.*gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + ...
      ...
      2.*fc110.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(5, 5) + 2.*fc200.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 5)))./((3.*l1 - l3).*m1.*Mf);
...
for indf = 1:max(size(tkr3))
    ...
    h012 = (-(hd011.*m1.*Mf) + 6.*gamma.*h101.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) - 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) + ...
     6.*gamma.*h011.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) - 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - 3.*gamma.*m1.*xi1.^2.*P(1, 2).*PI(3, 4) - ...
     3.*gamma.*Mf.*xi1.^2.*P(1, 2).*PI(3, 4) - 6.*gamma.*m1.*xi0.*xi2.*P(1, 2).*PI(3, 4) - 6.*gamma.*Mf.*xi0.*xi2.*P(1, 2).*PI(3, 4) - 6.*gamma.*h011.*m1.*xi0.*xi1.*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*hc011.*m1.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc011.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*f011.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(3, 4) - ...
     6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*fc011.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc011.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 4) + 3.*gamma.*Mf.*xi1.^2.*P(1, 2).*PI(3, 5) + ...
     6.*gamma.*Mf.*xi0.*xi2.*P(1, 2).*PI(3, 5) + 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 5) + 6.*gamma.*hc011.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 5) + 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 5) + ...
     6.*fc011.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 5))./((l1 - l2).*m1.*Mf);


h102 = (-(hd101.*m1.*Mf) + 6.*gamma.*h101.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) - 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) + ...
     6.*gamma.*h011.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) - 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - 3.*gamma.*m1.*xi1.^2.*P(1, 1).*PI(3, 4) - ...
     3.*gamma.*Mf.*xi1.^2.*P(1, 1).*PI(3, 4) - 6.*gamma.*m1.*xi0.*xi2.*P(1, 1).*PI(3, 4) - 6.*gamma.*Mf.*xi0.*xi2.*P(1, 1).*PI(3, 4) - 6.*gamma.*h101.*m1.*xi0.*xi1.*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*hc101.*m1.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc101.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*f101.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(3, 4) - ...
     6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*fc101.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc101.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 4) + 3.*gamma.*Mf.*xi1.^2.*P(1, 1).*PI(3, 5) + ...
     6.*gamma.*Mf.*xi0.*xi2.*P(1, 1).*PI(3, 5) + 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 5) + 6.*gamma.*hc101.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 5) + 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 5) + ...
     6.*fc101.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 5))./((l1 - l2).*m1.*Mf);

h201 = (-(hd200.*m1.*Mf) + 12.*gamma.*h200.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 12.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 3.*gamma.*h101.*m1.*xi0.*P(1, 1).^2.*PI(1, 4) + ...
     3.*gamma.*h101.*Mf.*xi0.*P(1, 1).^2.*PI(1, 4) - 12.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) - 3.*gamma.*h101.*Mf.*xi0.*P(1, 1).^2.*PI(1, 5) + 6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + ...
     6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 3.*gamma.*h011.*m1.*xi0.*P(1, 1).^2.*PI(2, 4) + 3.*gamma.*h011.*Mf.*xi0.*P(1, 1).^2.*PI(2, 4) - 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - ...
     3.*gamma.*h011.*Mf.*xi0.*P(1, 1).^2.*PI(2, 5) - 3.*gamma.*m1.*xi1.*P(1, 1).^2.*PI(3, 4) - 3.*gamma.*Mf.*xi1.*P(1, 1).^2.*PI(3, 4) - 6.*gamma.*h200.*m1.*xi0.*xi1.*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*h101.*m1.*xi0.*P(1, 1).*P(1, 3).*PI(3, 4) - 6.*gamma.*h101.*Mf.*xi0.*P(1, 1).*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*hc200.*m1.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc200.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc101.*m1.*xi0.*P(1, 1).*P(1, 4).*PI(3, 4) - ...
     6.*gamma.*hc101.*Mf.*xi0.*P(1, 1).*P(1, 4).*PI(3, 4) - 6.*f200.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 4) - ...
     6.*f101.*gamma.*m1.*xi0.*P(1, 1).*P(1, 5).*PI(3, 4) - 6.*f101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 5).*PI(3, 4) - 6.*fc200.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(3, 4) - ... 
     6.*fc200.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc101.*gamma.*m1.*xi0.*P(1, 1).*P(1, 6).*PI(3, 4) - 6.*fc101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(3, 4) + ...
     ...
     6.*fc200.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 5) + 6.*fc101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(3, 5))./((2.*l1 - l2).*m1.*Mf);

h021 = (-(hd020.*m1.*Mf) + 6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 3.*gamma.*h101.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + ...
     3.*gamma.*h101.*Mf.*xi0.*P(1, 2).^2.*PI(1, 4) - 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) - 3.*gamma.*h101.*Mf.*xi0.*P(1, 2).^2.*PI(1, 5) + 12.*gamma.*h020.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + ...
     12.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 3.*gamma.*h011.*m1.*xi0.*P(1, 2).^2.*PI(2, 4) + 3.*gamma.*h011.*Mf.*xi0.*P(1, 2).^2.*PI(2, 4) - 12.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - ...
     3.*gamma.*h011.*Mf.*xi0.*P(1, 2).^2.*PI(2, 5) - 3.*gamma.*m1.*xi1.*P(1, 2).^2.*PI(3, 4) - 3.*gamma.*Mf.*xi1.*P(1, 2).^2.*PI(3, 4) - 6.*gamma.*h020.*m1.*xi0.*xi1.*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*h011.*m1.*xi0.*P(1, 2).*P(1, 3).*PI(3, 4) - 6.*gamma.*h011.*Mf.*xi0.*P(1, 2).*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*hc020.*m1.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc020.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc011.*m1.*xi0.*P(1, 2).*P(1, 4).*PI(3, 4) - ...
     6.*gamma.*hc011.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(3, 4) - 6.*f020.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 4) - ...
     6.*f011.*gamma.*m1.*xi0.*P(1, 2).*P(1, 5).*PI(3, 4) - 6.*f011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(3, 4) - 6.*fc020.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(3, 4) - ...
     6.*fc020.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc011.*gamma.*m1.*xi0.*P(1, 2).*P(1, 6).*PI(3, 4) - 6.*fc011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 4) + ...
     ...
     6.*fc020.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 5) + 6.*fc011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 5))./((2.*l1 - l2).*m1.*Mf);


h111 = (-(hd110.*m1.*Mf) + 6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 12.*gamma.*h200.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + ...
     12.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*gamma.*h101.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 6.*gamma.*h101.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) - ...
     6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) - 12.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) - 6.*gamma.*h101.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 5) + ...
     12.*gamma.*h020.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 12.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) + ...
     6.*gamma.*h011.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(2, 4) + 6.*gamma.*h011.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(2, 4) - 12.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - ...
     6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - 6.*gamma.*h011.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(2, 5) - 6.*gamma.*m1.*xi1.*P(1, 1).*P(1, 2).*PI(3, 4) - 6.*gamma.*Mf.*xi1.*P(1, 1).*P(1, 2).*PI(3, 4) - ...
     6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 3).*PI(3, 4) - 6.*gamma.*h011.*m1.*xi0.*P(1, 1).*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*h011.*Mf.*xi0.*P(1, 1).*P(1, 3).*PI(3, 4) - 6.*gamma.*h101.*m1.*xi0.*P(1, 2).*P(1, 3).*PI(3, 4) - 6.*gamma.*h101.*Mf.*xi0.*P(1, 2).*P(1, 3).*PI(3, 4) - ...
     6.*gamma.*hc110.*m1.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc110.*Mf.*xi0.*xi1.*P(1, 4).*PI(3, 4) - 6.*gamma.*hc011.*m1.*xi0.*P(1, 1).*P(1, 4).*PI(3, 4) - ...
     6.*gamma.*hc011.*Mf.*xi0.*P(1, 1).*P(1, 4).*PI(3, 4) - 6.*gamma.*hc101.*m1.*xi0.*P(1, 2).*P(1, 4).*PI(3, 4) - 6.*gamma.*hc101.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(3, 4) - ...
     6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(3, 4) - 6.*f011.*gamma.*m1.*xi0.*P(1, 1).*P(1, 5).*PI(3, 4) - ...
     6.*f011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 5).*PI(3, 4) - 6.*f101.*gamma.*m1.*xi0.*P(1, 2).*P(1, 5).*PI(3, 4) - 6.*f101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(3, 4) - ...
     6.*fc110.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc110.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(3, 4) - 6.*fc011.*gamma.*m1.*xi0.*P(1, 1).*P(1, 6).*PI(3, 4) - ...
     6.*fc011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(3, 4) - 6.*fc101.*gamma.*m1.*xi0.*P(1, 2).*P(1, 6).*PI(3, 4) - 6.*fc101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 4) + ...
     ...
     6.*fc101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(3, 5))./((2.*l1 - l2).*m1.*Mf);


f012 = (-(fd011.*m1.*Mf) + 6.*f101.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) - 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) + ...
     6.*f011.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) - 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - 3.*gamma.*m1.*xi1.^2.*P(1, 2).*PI(5, 4) - ...
     3.*gamma.*Mf.*xi1.^2.*P(1, 2).*PI(5, 4) - 6.*gamma.*m1.*xi0.*xi2.*P(1, 2).*PI(5, 4) - 6.*gamma.*Mf.*xi0.*xi2.*P(1, 2).*PI(5, 4) - 6.*gamma.*h011.*m1.*xi0.*xi1.*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*hc011.*m1.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc011.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*f011.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(5, 4) - ...
     6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*fc011.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc011.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 4) + 3.*gamma.*Mf.*xi1.^2.*P(1, 2).*PI(5, 5) + ...
     6.*gamma.*Mf.*xi0.*xi2.*P(1, 2).*PI(5, 5) + 6.*gamma.*h011.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 5) + 6.*gamma.*hc011.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 5) + 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 5) + ...
     6.*fc011.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 5))./((l1 - l3).*m1.*Mf);

f102 = (-(fd101.*m1.*Mf) + 6.*f101.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) - 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) + ...
     6.*f011.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) - 6.*f011.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - 3.*gamma.*m1.*xi1.^2.*P(1, 1).*PI(5, 4) - ...
     3.*gamma.*Mf.*xi1.^2.*P(1, 1).*PI(5, 4) - 6.*gamma.*m1.*xi0.*xi2.*P(1, 1).*PI(5, 4) - 6.*gamma.*Mf.*xi0.*xi2.*P(1, 1).*PI(5, 4) - 6.*gamma.*h101.*m1.*xi0.*xi1.*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*hc101.*m1.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc101.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*f101.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(5, 4) - ...
     6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*fc101.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc101.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 4) + 3.*gamma.*Mf.*xi1.^2.*P(1, 1).*PI(5, 5) + ...
     6.*gamma.*Mf.*xi0.*xi2.*P(1, 1).*PI(5, 5) + 6.*gamma.*h101.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 5) + 6.*gamma.*hc101.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 5) + 6.*f101.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 5) + ...
     6.*fc101.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 5))./((l1 - l3).*m1.*Mf);


f201 = (-(fd200.*m1.*Mf) + 12.*f200.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 12.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 3.*f101.*gamma.*m1.*xi0.*P(1, 1).^2.*PI(1, 4) + ...
     3.*f101.*gamma.*Mf.*xi0.*P(1, 1).^2.*PI(1, 4) - 12.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) - 3.*f101.*gamma.*Mf.*xi0.*P(1, 1).^2.*PI(1, 5) + 6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + ...
     6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 3.*f011.*gamma.*m1.*xi0.*P(1, 1).^2.*PI(2, 4) + 3.*f011.*gamma.*Mf.*xi0.*P(1, 1).^2.*PI(2, 4) - 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - ...
     3.*f011.*gamma.*Mf.*xi0.*P(1, 1).^2.*PI(2, 5) - 3.*gamma.*m1.*xi1.*P(1, 1).^2.*PI(5, 4) - 3.*gamma.*Mf.*xi1.*P(1, 1).^2.*PI(5, 4) - 6.*gamma.*h200.*m1.*xi0.*xi1.*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*h200.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*h101.*m1.*xi0.*P(1, 1).*P(1, 3).*PI(5, 4) - 6.*gamma.*h101.*Mf.*xi0.*P(1, 1).*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*hc200.*m1.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc200.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc101.*m1.*xi0.*P(1, 1).*P(1, 4).*PI(5, 4) - ...
     6.*gamma.*hc101.*Mf.*xi0.*P(1, 1).*P(1, 4).*PI(5, 4) - 6.*f200.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 4) - ...
     6.*f101.*gamma.*m1.*xi0.*P(1, 1).*P(1, 5).*PI(5, 4) - 6.*f101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 5).*PI(5, 4) - 6.*fc200.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(5, 4) - ...
     6.*fc200.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc101.*gamma.*m1.*xi0.*P(1, 1).*P(1, 6).*PI(5, 4) - 6.*fc101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(5, 4) + ...
     ...
     6.*fc200.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 5) + 6.*fc101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(5, 5))./((2.*l1 - l3).*m1.*Mf);

f021 = (-(fd020.*m1.*Mf) + 6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 3.*f101.*gamma.*m1.*xi0.*P(1, 2).^2.*PI(1, 4) + ...
     3.*f101.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(1, 4) - 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) - 3.*f101.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(1, 5) + 12.*f020.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + ...
     12.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 3.*f011.*gamma.*m1.*xi0.*P(1, 2).^2.*PI(2, 4) + 3.*f011.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(2, 4) - 12.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - ...
     3.*f011.*gamma.*Mf.*xi0.*P(1, 2).^2.*PI(2, 5) - 3.*gamma.*m1.*xi1.*P(1, 2).^2.*PI(5, 4) - 3.*gamma.*Mf.*xi1.*P(1, 2).^2.*PI(5, 4) - 6.*gamma.*h020.*m1.*xi0.*xi1.*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*h020.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*h011.*m1.*xi0.*P(1, 2).*P(1, 3).*PI(5, 4) - 6.*gamma.*h011.*Mf.*xi0.*P(1, 2).*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*hc020.*m1.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc020.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc011.*m1.*xi0.*P(1, 2).*P(1, 4).*PI(5, 4) - ...
     6.*gamma.*hc011.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(5, 4) - 6.*f020.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 4) - ...
     6.*f011.*gamma.*m1.*xi0.*P(1, 2).*P(1, 5).*PI(5, 4) - 6.*f011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(5, 4) - 6.*fc020.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(5, 4) - ...
     6.*fc020.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc011.*gamma.*m1.*xi0.*P(1, 2).*P(1, 6).*PI(5, 4) - 6.*fc011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 4) + ...
     ...
     6.*fc020.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 5) + 6.*fc011.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 5))./((2.*l1 - l3).*m1.*Mf);


f111 = (-(fd110.*m1.*Mf) + 6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 4) + 12.*f200.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(1, 4) + ...
     12.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 4) + 6.*f101.*gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) + 6.*f101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 4) - ...
     6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(1, 5) - 12.*f200.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(1, 5) - 6.*f101.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(1, 5) + ...
     12.*f020.*gamma.*m1.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 12.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 4) + 6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 2).*PI(2, 4) + 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 4) + ...
     6.*f011.*gamma.*m1.*xi0.*P(1, 1).*P(1, 2).*PI(2, 4) + 6.*f011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(2, 4) - 12.*f020.*gamma.*Mf.*xi0.*xi1.*P(1, 1).*PI(2, 5) - ...
     6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 2).*PI(2, 5) - 6.*f011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 2).*PI(2, 5) - 6.*gamma.*m1.*xi1.*P(1, 1).*P(1, 2).*PI(5, 4) - 6.*gamma.*Mf.*xi1.*P(1, 1).*P(1, 2).*PI(5, 4) - ...
     6.*gamma.*h110.*m1.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*h110.*Mf.*xi0.*xi1.*P(1, 3).*PI(5, 4) - 6.*gamma.*h011.*m1.*xi0.*P(1, 1).*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*h011.*Mf.*xi0.*P(1, 1).*P(1, 3).*PI(5, 4) - 6.*gamma.*h101.*m1.*xi0.*P(1, 2).*P(1, 3).*PI(5, 4) - 6.*gamma.*h101.*Mf.*xi0.*P(1, 2).*P(1, 3).*PI(5, 4) - ...
     6.*gamma.*hc110.*m1.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc110.*Mf.*xi0.*xi1.*P(1, 4).*PI(5, 4) - 6.*gamma.*hc011.*m1.*xi0.*P(1, 1).*P(1, 4).*PI(5, 4) - ...
     6.*gamma.*hc011.*Mf.*xi0.*P(1, 1).*P(1, 4).*PI(5, 4) - 6.*gamma.*hc101.*m1.*xi0.*P(1, 2).*P(1, 4).*PI(5, 4) - 6.*gamma.*hc101.*Mf.*xi0.*P(1, 2).*P(1, 4).*PI(5, 4) - ...
     6.*f110.*gamma.*m1.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*f110.*gamma.*Mf.*xi0.*xi1.*P(1, 5).*PI(5, 4) - 6.*f011.*gamma.*m1.*xi0.*P(1, 1).*P(1, 5).*PI(5, 4) - ...
     6.*f011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 5).*PI(5, 4) - 6.*f101.*gamma.*m1.*xi0.*P(1, 2).*P(1, 5).*PI(5, 4) - 6.*f101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 5).*PI(5, 4) - ...
     6.*fc110.*gamma.*m1.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc110.*gamma.*Mf.*xi0.*xi1.*P(1, 6).*PI(5, 4) - 6.*fc011.*gamma.*m1.*xi0.*P(1, 1).*P(1, 6).*PI(5, 4) - ...
     6.*fc011.*gamma.*Mf.*xi0.*P(1, 1).*P(1, 6).*PI(5, 4) - 6.*fc101.*gamma.*m1.*xi0.*P(1, 2).*P(1, 6).*PI(5, 4) - 6.*fc101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 4) + ...
     ...
     6.*fc101.*gamma.*Mf.*xi0.*P(1, 2).*P(1, 6).*PI(5, 5))./((2.*l1 - l3).*m1.*Mf);
