...
Mf = 4;
cf = 0.3;
K = -[-k,k*m/(m+Mf);k*m/(m+Mf),4*a^2*m*g-k*m^2/(m+Mf)^2];
...
xi_2 = @(alpha,A) (inv(Aalph(Force_Lorenz(alpha),A))*(xi_1D(alpha).'-[0;0;0;(m+Mf)/(m*Mf)*(-4*g*m*3*xi_20(alpha)*xi_21(alpha,A)^2-16*m*a^4*xi_20(alpha)*xi_41(alpha,A)^2)]));
...
xi_3 = @(alpha,A) (inv(Aalph(Force_Lorenz(alpha),A))*(xi_2D(alpha).'-[0;0;0;(Mf+m)/(Mf*m)*...
    (-4*g*m*(xi_21(alpha,A)^3 + 6 * xi_20(alpha)*xi_21(alpha,A)*xi_22(alpha,A)) - ...
    16*m*a^4*(xi_21(alpha,A)*xi_41(alpha,A)^2 + 2*xi_20(alpha)*xi_41(alpha,A)*xi_42(alpha,A) ))]));
...
h101 = (-294.*xi20*xi21*P(2., 1.)*PI(3., 4.) - 40.*xi20*xi41*P(4., 1.)*PI(3., 4.))/(l1 - 1.*l3);
hc101 = conj(h101);

h200 = (-147.*xi20*P(2., 1.)^2*PI(3., 4.) - 20.*xi20*P(4., 1.)^2*PI(3., 4.))/(2.*l1 - 1.*l3);
hc200 = conj(h200);

h011 = (-294.*xi20*xi21*P(2., 2.)*PI(3., 4.) - 40.*xi20*xi41*P(4., 2.)*PI(3., 4.))/(l2 - 1.*l3);
hc011 = conj(h011);

h110 = (-294.*xi20*P(2., 1.)*P(2., 2.)*PI(3., 4.) - 40.*xi20*P(4., 1.)*P(4., 2.)*PI(3., 4.))/(l1 + l2 - 1.*l3);
hc110 = conj(h110);

h020 = (-147.*xi20*P(2., 2.)^2*PI(3., 4.) - 20.*xi20*P(4., 2.)^2*PI(3., 4.))/(2.*l2 - 1.*l3);
hc020 = conj(h020);

h300 = (294.*h200*xi20*P(2., 1.)^2*PI(1., 4.) + 40.*h200*xi20*P(4., 1.)^2*PI(1., 4.) + 147.*h110*xi20*P(2., 1.)^2*PI(2., 4.) + 20.*h110*xi20*P(4., 1.)^2*PI(2., 4.) - ...
     49.*P(2., 1.)^3*PI(3., 4.) - 294.*h200*xi20*P(2., 1.)*P(2., 3.)*PI(3., 4.) - 294.*hc200*xi20*P(2., 1.)*P(2., 4.)*PI(3., 4.) - 20.*P(2., 1.)*P(4., 1.)^2*PI(3., 4.) - ...
     40.*h200*xi20*P(4., 1.)*P(4., 3.)*PI(3., 4.) - 40.*hc200*xi20*P(4., 1.)*P(4., 4.)*PI(3., 4.))/(3.*l1 - 1.*l3);

h030 = (147.*h110*xi20*P(2., 2.)^2*PI(1., 4.) + 20.*h110*xi20*P(4., 2.)^2*PI(1., 4.) + 294.*h020*xi20*P(2., 2.)^2*PI(2., 4.) + 40.*h020*xi20*P(4., 2.)^2*PI(2., 4.) - ...
     49.*P(2., 2.)^3*PI(3., 4.) - 294.*h020*xi20*P(2., 2.)*P(2., 3.)*PI(3., 4.) - 294.*hc020*xi20*P(2., 2.)*P(2., 4.)*PI(3., 4.) - 20.*P(2., 2.)*P(4., 2.)^2*PI(3., 4.) - ...
     40.*h020*xi20*P(4., 2.)*P(4., 3.)*PI(3., 4.) - 40.*hc020*xi20*P(4., 2.)*P(4., 4.)*PI(3., 4.))/(3.*l2 - 1.*l3);
h120 = (294.*h110*xi20*P(2., 1.)*P(2., 2.)*PI(1., 4.) + 294.*h200*xi20*P(2., 2.)^2*PI(1., 4.) + 40.*h110*xi20*P(4., 1.)*P(4., 2.)*PI(1., 4.) + ...
     40.*h200*xi20*P(4., 2.)^2*PI(1., 4.) + 588.*h020*xi20*P(2., 1.)*P(2., 2.)*PI(2., 4.) + 147.*h110*xi20*P(2., 2.)^2*PI(2., 4.) + 80.*h020*xi20*P(4., 1.)*P(4., 2.)*PI(2., 4.) + ...
     20.*h110*xi20*P(4., 2.)^2*PI(2., 4.) - 147.*P(2., 1.)*P(2., 2.)^2*PI(3., 4.) - 294.*h020*xi20*P(2., 1.)*P(2., 3.)*PI(3., 4.) - ...
     294.*h110*xi20*P(2., 2.)*P(2., 3.)*PI(3., 4.) - 294.*hc020*xi20*P(2., 1.)*P(2., 4.)*PI(3., 4.) - 294.*hc110*xi20*P(2., 2.)*P(2., 4.)*PI(3., 4.) - ...
     40.*P(2., 2.)*P(4., 1.)*P(4., 2.)*PI(3., 4.) - 20.*P(2., 1.)*P(4., 2.)^2*PI(3., 4.) - 40.*h020*xi20*P(4., 1.)*P(4., 3.)*PI(3., 4.) - ...
     40.*h110*xi20*P(4., 2.)*P(4., 3.)*PI(3., 4.) - 40.*hc020*xi20*P(4., 1.)*P(4., 4.)*PI(3., 4.) - 40.*hc110*xi20*P(4., 2.)*P(4., 4.)*PI(3., 4.))/(l1 + 2.*l2 - 1.*l3);

h210 = (147.*h110*xi20*P(2., 1.)^2*PI(1., 4.) + 588.*h200*xi20*P(2., 1.)*P(2., 2.)*PI(1., 4.) + 20.*h110*xi20*P(4., 1.)^2*PI(1., 4.) + ...
     80.*h200*xi20*P(4., 1.)*P(4., 2.)*PI(1., 4.) + 294.*h020*xi20*P(2., 1.)^2*PI(2., 4.) + 294.*h110*xi20*P(2., 1.)*P(2., 2.)*PI(2., 4.) + 40.*h020*xi20*P(4., 1.)^2*PI(2., 4.) + ...
     40.*h110*xi20*P(4., 1.)*P(4., 2.)*PI(2., 4.) - 147.*P(2., 1.)^2*P(2., 2.)*PI(3., 4.) - 294.*h110*xi20*P(2., 1.)*P(2., 3.)*PI(3., 4.) - ...
     294.*h200*xi20*P(2., 2.)*P(2., 3.)*PI(3., 4.) - 294.*hc110*xi20*P(2., 1.)*P(2., 4.)*PI(3., 4.) - 294.*hc200*xi20*P(2., 2.)*P(2., 4.)*PI(3., 4.) - ...
     20.*P(2., 2.)*P(4., 1.)^2*PI(3., 4.) - 40.*P(2., 1.)*P(4., 1.)*P(4., 2.)*PI(3., 4.) - 40.*h110*xi20*P(4., 1.)*P(4., 3.)*PI(3., 4.) - ...
     40.*h200*xi20*P(4., 2.)*P(4., 3.)*PI(3., 4.) - 40.*hc110*xi20*P(4., 1.)*P(4., 4.)*PI(3., 4.) - 40.*hc200*xi20*P(4., 2.)*P(4., 4.)*PI(3., 4.))/(2.*l1 + l2 - 1.*l3);
...
h012 = (-hd011 + 294.*h101*xi20*xi21*P(2., 2.)*PI(1., 4.) + 40.*h101*xi20*xi41*P(4., 2.)*PI(1., 4.) + 294.*h011*xi20*xi21*P(2., 2.)*PI(2., 4.) + ...
     40.*h011*xi20*xi41*P(4., 2.)*PI(2., 4.) - 147.*xi21^2*P(2., 2.)*PI(3., 4.) - 294.*xi20*xi22*P(2., 2.)*PI(3., 4.) - 20.*xi41^2*P(2., 2.)*PI(3., 4.) - ...
     294.*h011*xi20*xi21*P(2., 3.)*PI(3., 4.) - 294.*hc011*xi20*xi21*P(2., 4.)*PI(3., 4.) - 40.*xi21*xi41*P(4., 2.)*PI(3., 4.) - 40.*xi20*xi42*P(4., 2.)*PI(3., 4.) - ...
     40.*h011*xi20*xi41*P(4., 3.)*PI(3., 4.) - 40.*hc011*xi20*xi41*P(4., 4.)*PI(3., 4.))/(l2 - 1.*l3);


h102 = (-hd101 + 294.*h101*xi20*xi21*P(2., 1.)*PI(1., 4.) + 40.*h101*xi20*xi41*P(4., 1.)*PI(1., 4.) + 294.*h011*xi20*xi21*P(2., 1.)*PI(2., 4.) + ...
     40.*h011*xi20*xi41*P(4., 1.)*PI(2., 4.) - 147.*xi21^2*P(2., 1.)*PI(3., 4.) - 294.*xi20*xi22*P(2., 1.)*PI(3., 4.) - 20.*xi41^2*P(2., 1.)*PI(3., 4.) - ...
     294.*h101*xi20*xi21*P(2., 3.)*PI(3., 4.) - 294.*hc101*xi20*xi21*P(2., 4.)*PI(3., 4.) - 40.*xi21*xi41*P(4., 1.)*PI(3., 4.) - 40.*xi20*xi42*P(4., 1.)*PI(3., 4.) - ...
     40.*h101*xi20*xi41*P(4., 3.)*PI(3., 4.) - 40.*hc101*xi20*xi41*P(4., 4.)*PI(3., 4.))/(l1 - 1.*l3);
   

h201 = (-hd200 + 588.*h200*xi20*xi21*P(2., 1.)*PI(1., 4.) + 147.*h101*xi20*P(2., 1.)^2*PI(1., 4.) + 80.*h200*xi20*xi41*P(4., 1.)*PI(1., 4.) + ...
     20.*h101*xi20*P(4., 1.)^2*PI(1., 4.) + 294.*h110*xi20*xi21*P(2., 1.)*PI(2., 4.) + 147.*h011*xi20*P(2., 1.)^2*PI(2., 4.) + 40.*h110*xi20*xi41*P(4., 1.)*PI(2., 4.) + ...
     20.*h011*xi20*P(4., 1.)^2*PI(2., 4.) - 147.*xi21*P(2., 1.)^2*PI(3., 4.) - 294.*h200*xi20*xi21*P(2., 3.)*PI(3., 4.) - 294.*h101*xi20*P(2., 1.)*P(2., 3.)*PI(3., 4.) - ...
     294.*hc200*xi20*xi21*P(2., 4.)*PI(3., 4.) - 294.*hc101*xi20*P(2., 1.)*P(2., 4.)*PI(3., 4.) - 40.*xi41*P(2., 1.)*P(4., 1.)*PI(3., 4.) - 20.*xi21*P(4., 1.)^2*PI(3., 4.) - ...
     40.*h200*xi20*xi41*P(4., 3.)*PI(3., 4.) - 40.*h101*xi20*P(4., 1.)*P(4., 3.)*PI(3., 4.) - 40.*hc200*xi20*xi41*P(4., 4.)*PI(3., 4.) - ...
     40.*hc101*xi20*P(4., 1.)*P(4., 4.)*PI(3., 4.))/(2.*l1 - 1.*l3);



h021 = (-hd020 + 294.*h110*xi20*xi21*P(2., 2.)*PI(1., 4.) + 147.*h101*xi20*P(2., 2.)^2*PI(1., 4.) + 40.*h110*xi20*xi41*P(4., 2.)*PI(1., 4.) + ...
     20.*h101*xi20*P(4., 2.)^2*PI(1., 4.) + 588.*h020*xi20*xi21*P(2., 2.)*PI(2., 4.) + 147.*h011*xi20*P(2., 2.)^2*PI(2., 4.) + 80.*h020*xi20*xi41*P(4., 2.)*PI(2., 4.) + ...
     20.*h011*xi20*P(4., 2.)^2*PI(2., 4.) - 147.*xi21*P(2., 2.)^2*PI(3., 4.) - 294.*h020*xi20*xi21*P(2., 3.)*PI(3., 4.) - 294.*h011*xi20*P(2., 2.)*P(2., 3.)*PI(3., 4.) - ...
     294.*hc020*xi20*xi21*P(2., 4.)*PI(3., 4.) - 294.*hc011*xi20*P(2., 2.)*P(2., 4.)*PI(3., 4.) - 40.*xi41*P(2., 2.)*P(4., 2.)*PI(3., 4.) - 20.*xi21*P(4., 2.)^2*PI(3., 4.) - ...
     40.*h020*xi20*xi41*P(4., 3.)*PI(3., 4.) - 40.*h011*xi20*P(4., 2.)*P(4., 3.)*PI(3., 4.) - 40.*hc020*xi20*xi41*P(4., 4.)*PI(3., 4.) - ...
     40.*hc011*xi20*P(4., 2.)*P(4., 4.)*PI(3., 4.))/(2.*l2 - 1.*l3);


h111 = (-hd110 + 294.*h110*xi20*xi21*P(2., 1.)*PI(1., 4.) + 588.*h200*xi20*xi21*P(2., 2.)*PI(1., 4.) + 294.*h101*xi20*P(2., 1.)*P(2., 2.)*PI(1., 4.) + ...
     40.*h110*xi20*xi41*P(4., 1.)*PI(1., 4.) + 80.*h200*xi20*xi41*P(4., 2.)*PI(1., 4.) + 40.*h101*xi20*P(4., 1.)*P(4., 2.)*PI(1., 4.) + 588.*h020*xi20*xi21*P(2., 1.)*PI(2., 4.) + ...
     294.*h110*xi20*xi21*P(2., 2.)*PI(2., 4.) + 294.*h011*xi20*P(2., 1.)*P(2., 2.)*PI(2., 4.) + 80.*h020*xi20*xi41*P(4., 1.)*PI(2., 4.) + ...
     40.*h110*xi20*xi41*P(4., 2.)*PI(2., 4.) + 40.*h011*xi20*P(4., 1.)*P(4., 2.)*PI(2., 4.) - 294.*xi21*P(2., 1.)*P(2., 2.)*PI(3., 4.) - ...
     294.*h110*xi20*xi21*P(2., 3.)*PI(3., 4.) - 294.*h011*xi20*P(2., 1.)*P(2., 3.)*PI(3., 4.) - 294.*h101*xi20*P(2., 2.)*P(2., 3.)*PI(3., 4.) - ...
     294.*hc110*xi20*xi21*P(2., 4.)*PI(3., 4.) - 294.*hc011*xi20*P(2., 1.)*P(2., 4.)*PI(3., 4.) - 294.*hc101*xi20*P(2., 2.)*P(2., 4.)*PI(3., 4.) - ...
     40.*xi41*P(2., 2.)*P(4., 1.)*PI(3., 4.) - 40.*xi41*P(2., 1.)*P(4., 2.)*PI(3., 4.) - 40.*xi21*P(4., 1.)*P(4., 2.)*PI(3., 4.) - 40.*h110*xi20*xi41*P(4., 3.)*PI(3., 4.) - ...
     40.*h011*xi20*P(4., 1.)*P(4., 3.)*PI(3., 4.) - 40.*h101*xi20*P(4., 2.)*P(4., 3.)*PI(3., 4.) - 40.*hc110*xi20*xi41*P(4., 4.)*PI(3., 4.) - ...
     40.*hc011*xi20*P(4., 1.)*P(4., 4.)*PI(3., 4.) - 40.*hc101*xi20*P(4., 2.)*P(4., 4.)*PI(3., 4.))/(l1 + l2 - 1.*l3);
...
ROM=@(t,z) rom_temp_model_adiabatic(t,z,SSM_Coeff_A_2,SSM_Coeff_A_1,xi_20,xi_21,xi_41,xi_22,xi_42,Valpha,V,A,Force_Lorenz,Dalpha,epsilon);
